...
"駆け出しエンジニア特化型のツイッター" をイメージして制作してみました。  
基本的な機能はツイッターを踏襲しています。  
他には勉強時間の記録や掲示板などの機能も搭載しています。

### サイトテーマ
*「駆け出しエンジニアはあなただけじゃない！  
&emsp;みんなで共感・雑談して人生のモチベーションを上げていこう！」*  
...
その結果、駆け出しエンジニア特化のSNSなら利用者の勉強継続をサポート可能だという結論に至りました。  
具体的には、以下のアクションにより利用者相互で勉強のモチベーションアップが期待できると考えています。  
- 勉強時間の記録機能により、利用者相互が勉強時間を比較する
- 掲示板機能により、利用者相互が意見や悩みを共有する

### 名前に込めた意味
*「エンジニアになって人生を変えたい！」*  

駆け出しエンジニアなら誰しもこのように考えていると思います。  
